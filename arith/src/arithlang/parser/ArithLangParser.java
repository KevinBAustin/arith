...
public class ArithLangParser extends Parser {
	...
	public final AsgexpContext asgexp() throws RecognitionException {
		...
		try {
			...
			match(T__0);
			setState(51);
			((AsgexpContext)_localctx).r = exp();
			_localctx.ast = new AsgExp( (((AsgexpContext)_localctx).l!=null?((AsgexpContext)_localctx).l.getText():null), ((AsgexpContext)_localctx).r.ast)
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public static final String _serializedATN =
		...
		"\2\63\64\7\r\2\2\64\65\7\3\2\2\65\66\5\4\3\2\66\67\b\4\1\2\67\7\3\2\2"+
